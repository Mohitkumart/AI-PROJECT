...
from utils.document_reader import (
    read_pdf_text,
    read_excel_text,
    count_employees_from_text,
    get_combined_text_from_data_folder
)
...
class DocumentReaderTool:
    def __init__(self):
        self._document_reader_tool_list = self._setup_tools()
    ...
    def _setup_tools(self) -> List:
        ...
        def read_excel(file_path: str) -> str:
            ...
            try:
                return read_excel_text(file_path)
            except Exception as e:
        ...
        def count_employees_from_pdf_text(pdf_text: str) -> str:
            ...
            try:
                return count_employees_from_text(pdf_text)
            except Exception as e:
                return f"Error counting employees: {str(e)}"

        return [read_pdf, read_excel, count_employees_from_pdf_text]
    ...
    def get_combined_text(self) -> str:
        ...
        return get_combined_text_from_data_folder()
